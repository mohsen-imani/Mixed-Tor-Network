...
connection_exit_begin_conn(cell_t *cell, circuit_t *circ)
{
  ...
  tor_log(LOG_NOTICE, LD_CONTROL,"iSec|IP|%s|AT|%ld|%ld|EXITCONN|CIRCID|%u|BGN|%d|ADDR|%s|DONE",get_options()->MYIP,tv.tv_sec,tv.tv_usec, (unsigned)or_circ->p_circ_id, rh.command,address);
